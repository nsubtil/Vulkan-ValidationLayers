...
class ObjectTrackerOutputGenerator(OutputGenerator):
    ...
    def beginFile(self, genOpts):
        ...
        # Namespace
        self.newline()
        self.otwrite('both', '#ifdef UBER_LAYER')
        self.otwrite('both', '#include "core_validation.h"')
        self.otwrite('both', '#include "core_validation_data.h"')
        self.otwrite('util', 'using core_validation::layer_data;')
        self.otwrite('util', 'using core_validation::instance_layer_data;')
        self.otwrite('both', '#else')
        self.otwrite('both', '#include "object_tracker.h"')
        self.otwrite('both', '#endif')
